...
describe("Modèle de calcul de l'index d'écart de rémunérations", () => {
  ...
  // test.each([
  //   {
  //     name: "testsRemunerations",
  //     values: testsRemunerations,
  //   },
  //   {
  //     name: "testsAugmentations",
  //     values: testsAugmentations,
  //   },
  //   {
  //     name: "testsPromotions",
  //     values: testsPromotions,
  //   },
  //   {
  //     name: "testsMaternité",
  //     values: testsMaternité,
  //   },
  //   {
  //     name: "testsHautesRémunérations",
  //     values: testsHautesRémunérations,
  //   },
  //   {
  //     name: "testsNote",
  //     values: testsNote,
